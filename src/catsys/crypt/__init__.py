...
# def keyfile_fromvcode(vcode1:Union[str,bytes], keytype:str) -> bytes:
#     """keyfile_fromvcode(vcode1, keytype) -> bytes

#     vcode1 (V_CODE) is used for keyfile generation, not vcode2 (V_CODE2)
#     """
#     return keyfile_generate(keyfile_seed(vcode1, keytype))

# def keyfile_fromseed(keyseed:int, keytype:str=...) -> bytes:
#     """keyfile_fromseed(keyseed[, keytype]) -> bytes

#     argument 'keytype' is ignored
#     """
#     return keyfile_generate(keyseed)
