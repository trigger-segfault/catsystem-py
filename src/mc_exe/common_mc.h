...
#ifndef KCLIB_MC_COMMON_HEADER_H
#define KCLIB_MC_COMMON_HEADER_H
...
///NOTE: below all of the defines <windows.h> is included
...
// Unfortunately including windows.h by default will help,
//  due to the shear number of classes that contain 
//  WINAPI structures and types within them.
#include <windows.h>
